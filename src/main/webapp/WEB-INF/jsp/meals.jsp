...
<head>
    ...
    <title><spring:message code="meals.management"/></title>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                ...
                <td>${meal.calories}</td>
                <td><a href="${pageContext.request.contextPath}/meals/update/${meal.id}"><spring:message code="meals.update"/></a></td>
                <td><a href="${pageContext.request.contextPath}/meals/delete/${meal.id}"><spring:message code="meals.delete"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
