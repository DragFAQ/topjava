...
public class MealsUtil {
    public static void main(String[] args) {
        ...
        System.out.println("-----");
        mealsWithExceeded = getFilteredWithExceeded(meals, null, null, 2000);
        mealsWithExceeded.forEach(System.out::println);
        System.out.println("-----");
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
        ...
        return meals.stream()
                .filter(meal -> startTime == null || endTime == null ? true : TimeUtil.isBetween(meal.getTime(), startTime, endTime))
