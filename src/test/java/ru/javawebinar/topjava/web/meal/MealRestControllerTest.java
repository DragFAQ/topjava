...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    public void testGetAll() throws Exception {
        TestUtil.print(mockMvc.perform(get(REST_URL))
                ...
                .andExpect(MEAL_EXCEED_MATCHER.contentListMatcher(getWithExceeded(MEALS, DEFAULT_CALORIES_PER_DAY))));
    }
    ...
    public void testGetBetweenDateTimes() throws Exception {
        TestUtil.print(mockMvc.perform(get(REST_URL + "filter")
                ...
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(MEAL_EXCEED_MATCHER.contentListMatcher(getWithExceeded(Arrays.asList(MEAL3, MEAL2, MEAL1), DEFAULT_CALORIES_PER_DAY))));
    }
